...
interface Project {
  ...
  /**
   * Puntos concretos que ayudan a mostrar capacidades importantes
   * sin obligar al usuario a descubrirlas dentro de un párrafo largo.
   *
   * Es opcional porque no todos los proyectos necesitan este nivel
   * de detalle.
   */
  highlights?: string[];
...
const getContent = (t: TFunction): CategoryGroup[] => [
  {
    ...
    projects: [
...

      {
        ...
        /**
         * Estos puntos hacen visible el verdadero diferencial del diario:
...
const Projects = () => {
  ...
  return (
    <section
      key={language}
      id="projects"
      className="py-32 bg-background transition-colors duration-500"
    >
  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-2/5 space-y-6">
        <Reveal delay={200}>
          <h4 className="text-foreground text-3xl md:text-4xl font-display leading-tight mb-4">
            {project.title}
          </h4>
